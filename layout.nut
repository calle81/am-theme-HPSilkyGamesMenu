...
class UserConfig {
	...
	</ label="Game Description Options", help="Specify how/ wehre to show game description", options="Over Flyer,Off", order=5 /> GameDescription="Off"
	</ label="Background colour as R,G,B", help="( 0-255 values allowed )\nSets the colour of background elements.\nLeave blank if you want the colour from the randomized to be stored permanently.", option="0", order=7 /> bgrgb="17,169,234"
	...
	</ label="Title colour as R,G,B", help="( 0-255 values allowed )\nSets the colour of accent elements.\nLeave blank if you want the colour from the randomized to be stored permanently.", option="0", order=9 /> titrgb="255,255,0" 
	</ label="Game Selection Bar Colour as R,G,B", help="( 0-255 values allowed )\nSets the colour of accent elements.\nLeave blank if you want the colour from the randomized to be stored permanently.", option="0", order=9 /> gslrgb="254,58,124" 
	</ label="Played Count Colour as R,G,B", help="( 0-255 values allowed )\nSets the colour of accent elements.\nLeave blank if you want the colour from the randomized to be stored permanently.", option="0", order=9 /> pldrgb="254,58,124" 
 </ label="--------    Cart Art Animation Otions     --------", help="Show or hide additional images", order=27 /> uct7="Select Below"
   </ label="Select Cart Art Folder", help="Select Cart Art Folder", options="wheel, marquee, flyer, fanart, boxart, cartart", order=29 /> select_bigartfolder="cartart";
   </ label="Enable Cart Art Fade on Selection", help="Enable Cart Art Fade on Selection", options="Yes,No", order=31 /> enable_bigartfade="No";
   </ label="Enable Cart Art Fade on Load", help="Enable Cart Art Fade on Load", options="Yes,No", order=32 /> enable_bigartfadeonload="No"; 
   </ label="Enable Cart Art Scale on Selection", help="Enable Cart Art Scale on Selection", options="Yes,No", order=33 /> enable_bigartscale="Yes"; 
   </ label="Enable Cart Art Scale on Load", help="Enable Cart Art Scale on Load", options="Yes,No", order=34 /> enable_bigartscaleonload="Yes"; 
   </ label="Enable Cart Art Rotate on Selection", help="Enable Cart Art Rotate on Selection", options="Yes,No", order=35 /> enable_bigartrotate="No";
   </ label="Enable Cart Art Rotate on Load", help="Enable Cart Art Rotate on Load", options="Yes,No", order=36 /> enable_bigartrotateonload="No";	 
   </ label="Enable Cart Art Fly-in on Selection", help="Enable Cart Art Fly-in on Selection", options="Yes,No", order=37 /> enable_bigartflyin="No";
</ label="--------    Box Art Animation Otions     --------", help="Show or hide additional images", order=38 /> uct8="Select Below";
   </ label="Select Box Art Foldert", help="Select Box Art Folder", options="wheel, marquee, flyer, fanart, boxart, cartart", order=40 /> select_bigartfolder2="boxart";
   </ label="Enable Box Art Fade on Selection", help="Enable Box Wheel Art Fade on Selection", options="Yes,No", order=42 /> enable_bigartfade2="No";
   </ label="Enable Box Art Fade on Load", help="Enable Box Art Fade on Load", options="Yes,No", order=43 /> enable_bigartfadeonload2="No"; 
   </ label="Enable Box Art Scale on Selection", help="Enable Box Art Scale on Selection", options="Yes,No", order=44 /> enable_bigartscale2="Yes"; 
   </ label="Enable Box Art Scale on Load", help="Enable Box Art Scale on Load", options="Yes,No", order=45 /> enable_bigartscaleonload2="Yes"; 
   </ label="Enable Box Art Rotate on Selection", help="Enable Box Art Rotate on Selection", options="Yes,No", order=46 /> enable_bigartrotate2="No";
   </ label="Enable Box Art Rotate on Load", help="Enable Box Art Rotate on Load", options="Yes,No", order=47 /> enable_bigartrotateonload2="No";	 
   </ label="Enable Box Art Fly-in on Selection", help="Enable Box Art Fly-in on Selection", options="Yes,No", order=48 /> enable_bigartflyin2="No";
 }
...
local flw = fe.layout.width;
local flh = fe.layout.height;
//local overlay_description = fe.add_image ("images/black.png", flx*0.73, fly*0.251, flw*0.25, flh*0.45)



if ( my_config["GameDescription"] == "Over Flyer" ){
local overlay_description = fe.add_image ("images/black.png", flx*0.73, fly*0.251, flw*0.25, flh*0.45)
...
playCountText.set_bg_rgb( pldRGB[0], pldRGB[1], pldRGB[2] )
...
local bigart = fe.add_artwork(( my_config["select_bigartfolder2"] ), flx*0.0, fly*0.2, flw*0.2, flh*0.45);
bigart.preserve_aspect_ratio = true;
bigart.trigger = Transition.EndNavigation;
...
//System Image
//////////
local systemimage = fe.add_image(( "systems/[DisplayName]"), flx*0.01, fly*0.6, flw*0.25, flh*0.25);
